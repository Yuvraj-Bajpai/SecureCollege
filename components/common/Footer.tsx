...
export function Footer() {
  return (
    <footer className="bg-surface border-t border-border">
      {/* Newsletter Section */}
      <div className="bg-blue-50 dark:bg-blue-950 py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              <Button 
                type="submit"
                className="bg-primary hover:bg-primary-600 text-white h-12 px-8"
              >
                Subscribe
              </Button>
            </form>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-10 h-10 rounded-full bg-primary hover:bg-primary-600 flex items-center justify-center text-white transition-all hover:scale-110"
                >
